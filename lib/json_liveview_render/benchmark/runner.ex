defmodule JsonLiveviewRender.Benchmark.Runner do
  ...
  def render_text(report) do
    ...
    [
      ...
      "\n",
      "  sections=",
      Integer.to_string(report.config.sections),
      "\n",
      "  columns=",
      Integer.to_string(report.config.columns),
      "\n",
      "  metrics_per_column=",
      Integer.to_string(report.config.metrics_per_column),
      "\n",
      "  format=",
      to_string(report.config.format),
      "\n",
      "  ci=",
      to_string(report.metadata.config.ci),
      "\n",
      "\n",
      "Metadata:\n",
      "  project=",
